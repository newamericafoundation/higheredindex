    ...
    return (
      <div className="simple-page download-home-page">
        ...
        <div className="simple-page__content">
          ...
          <p>options: 'states_grants', 'states_loans', 'states_outcomes', 'states_students', 'states_schools_all', 'states_schools_public4', 'states_schools_public2', 'states_schools_nonprofit', 'states_schools_forprofit', 'inst_grants', 'inst_loans', 'inst_outcomes', 'inst_students', 'inst_schools'</p>
