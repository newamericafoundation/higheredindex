		...
		trendsSettings: [
			{
				...
				calloutSettings: {
					type: "value",
					variables: [
						{variable:"mn_earn_wne_p10", displayName: "10-year", format:"price"},
						{variable:"mn_earn_wne_p8", displayName: "8-year", format:"price"},
						{variable:"mn_earn_wne_p6", displayName: "6-year", format:"price"},
					]
				},
				paragraphSettings: {
			...
			},
			{
				...
				paragraphSettings: {
					textSections: [["In @year, the mean earnings 10 years after enrolling in school were ", " for men and ", " for women at U.S. institutions."],
						["The following chart depicts trends over time."]],
					variables: [
